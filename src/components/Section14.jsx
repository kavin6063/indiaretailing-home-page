    ...
    <div>
      <div className="grid grid-cols-6 gap-4 p-4">
        ...
        <div className="col-span-4  p-4 rounded-md">
          ...
          <div className=" container mx-auto flex flex-row gap-4 items-center justify-between ">
            {posts.map((post, index) => (
              <div
                key={index}
                className="border border-gray-400 bg-white rounded-b lg:rounded-b-none lg:rounded-r flex flex-col justify-between leading-normal w-[230px] transition-transform hover:scale-105" // max width 270px
              >
                <img
                  src={post.image}
