            ...
            <div className="space-y-1">
              {posts.map((post, index) => (
                <a
                  key={index}
                  href="#"
                  className="flex flex-col items-center w-[450px] bg-white border border-gray-200 rounded-lg shadow md:flex-row md:max-w-xl hover:bg-gray-100 dark:border-gray-700 dark:bg-gray-800 dark:hover:bg-gray-700"
                >
                  <img
          ...
          <div>
            {posts3.map((post, index) => (
              <a
                key={index}
                href="#"
                className="flex flex-col items-center w-[335px] rounded-lg shadow md:flex-row md:max-w-xl hover:bg-gray-100 dark:border-gray-700 dark:bg-gray-800 dark:hover:bg-gray-700"
              >
